...
entity reg_file is
    ...
    port (
        ...
        -- Porta de Leitura para DEBUG 
        debug_addr_i : in  std_logic_vector(4 downto 0);          -- Endereço solicitado pelo Debugger
        debug_data_o : out std_logic_vector(31 downto 0)          -- Dado devolvido ao Debugger
...
begin
    ...
    -- Porta de Leitura 3 (para o Debugger)
