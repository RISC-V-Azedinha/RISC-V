...
#define TEST_AMO_OP(inst, destreg, origptr, reg2, origval, updval, sigptr, ...)           \
    ...
    RVTEST_SIGUPD(sigptr, reg2)                                                           \
    /*Write original AMO src */;                                                          \
...
#define TEST_IMM_OP(inst, destreg, reg, correctval, val, imm, swreg, offset, testreg) \
    ;                                                                                 \
    TEST_CASE(testreg, destreg, correctval, swreg, offset, ; LI(reg, MASK_XLEN(val)); inst destreg, reg, SEXT_IMM(imm);)
